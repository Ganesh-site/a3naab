...
export class SubCategoryFormComponent implements OnInit {
  ...
  editSubCategory(data){
    ...
    this.subCategoryForm = this.formBuilder.group({
      ...
      minimumOrderValue: [data['minimumOrderValue'],  [Validators.required, Validators.pattern(/^\S+(?: \S+)*$/)]],
      ...
      minOrderTime: [data['minOrderTime'],  [Validators.required, Validators.pattern(/^\S+(?: \S+)*$/)]],
